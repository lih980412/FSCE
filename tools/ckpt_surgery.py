...
def parse_args():
    ...
    # Dataset
    parser.add_argument('--mydataset', action='store_true',
...
def ckpt_surgery(args):
    ...
    def surgery(param_name, is_weight, tar_size, ckpt, ckpt2=None):
        ...
        if args.coco or args.lvis or args.mydataset:
            for i, c in enumerate(BASE_CLASSES):
                idx = i if args.coco or args.mydataset else c
                if 'cls_score' in param_name:
